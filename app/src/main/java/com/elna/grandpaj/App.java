...
public class App extends Application {
    ...
    private static final int LatestDatabaseVersion = 10;
    ...
    public void onCreate() {
        ...
        HandlerThread bgThread = new HandlerThread("Book Background");
        bgThread.start();
    ...
    private void copyDatabaseFile() {
        ...
        if (dbVersion != LatestDatabaseVersion) {
            ...
            try {
                BufferedInputStream is = new BufferedInputStream(getAssets().open("pjdb.sqlite"), 8192);
                ...
                L.w("Error writing book database", ex);
            }
        }
    }
